...
//Relations between tables in APPLICATION level (DRIZZLE-ORM) but not in DATABASE level
...
export const commentReactions = pgTable("comment_reactions", {
  ...
  primaryKey({
    ...
    //  "all reactions for a specific comment" (to show likes/dislikes on a comment)
