  ...
  revalidate: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      if (!existingVideo.muxUploadId) {
        throw new TRPCError({ code: "BAD_REQUEST", message: "Video does not have an upload ID" });
      }
  ...
  restoreThumbnail: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      if (!existingVideo.muxPlaybackId) {
        throw new TRPCError({ code: "BAD_REQUEST", message: "Video does not have a playback ID" });
      }
